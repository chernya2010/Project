...
# Processing models, for building product_url
...
class CategoryDetailedView(CartMixin, CategoryDetailMixin, DetailView):
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Спасибо за заказ! Наш менеджер свяжется Вами в ближайшее время.')

...
# Configuration and sorting recent arrivals
...
class CategoryManager(models.Manager):
    ...
    def get_categories_for_main_menu(self):
...
class Smartphone(Product):
    ...
    sd_volume_max = models.CharField(max_length=255, null=True, blank=True, verbose_name='Макcимальный объем SD карты')
...
class Order(models.Model):
    ...
    STATUS_CHOICES = (
        ...
        (STATUS_IN_PROGRESS, 'Заказ  обработке'),
    ...
    order_date = models.DateTimeField(verbose_name='Датаполучения заказа', default=timezone.now)
